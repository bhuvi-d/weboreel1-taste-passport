...
export const Selection = ({ dishes, selectedDishes, onToggle, onNext }) => {
  ...
  return (
    <section className="min-h-screen w-full bg-cream-base py-32 px-6 relative">
      {/* Background Ambience */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <header className="text-center mb-32">
          ...
          <motion.h2 
            ...
            className="font-display font-black text-6xl md:text-9xl text-spice-black mb-8 tracking-tighter leading-none"
          >
            Pardon Your <br />
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-saffron-900/40 max-w-2xl mx-auto font-medium tracking-tight"
          >
        ...
        <div className="sticky top-12 z-50 flex justify-center mb-24 pointer-events-none">
          <motion.div 
            className="glass-saffron px-10 py-6 rounded-[2.5rem] shadow-2xl flex items-center gap-10 pointer-events-auto border border-saffron-200/50"
            layout
          >
            <div className="flex flex-col">
               ...
               <div className="w-56 h-2 bg-saffron-100 rounded-full overflow-hidden border border-saffron-200/30">
                 <motion.div 
            ...
            <div className="h-12 w-px bg-saffron-200/50" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 md:gap-14 pb-48">
        ...
        <AnimatePresence>
          {selectedDishes.length >= 3 && (
            ...
            >
              <button
                onClick={onNext}
                className="btn-experience group scale-110 active:scale-100"
              >
                <Sparkles />
