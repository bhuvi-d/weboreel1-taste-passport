...
const ReelItem = ({ trait, recommendation, index, total }) => {
  ...
  return (
    <section className="h-screen w-full snap-start relative flex flex-col items-center justify-center bg-cream-base overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl px-8 flex flex-col lg:flex-row items-center gap-16 md:gap-32">
        ...
        <motion.div
          ...
          className="w-56 h-80 md:w-[450px] md:h-[600px] relative shrink-0"
        >
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <motion.h2 
            ...
            className="font-display font-black text-6xl md:text-[8rem] text-spice-black mb-10 leading-[0.8] tracking-tighter"
          >
            {recommendation.name}
          </motion.h2>
          ...
          <motion.div
             ...
             className="relative"
          >
            <p className="text-xl md:text-3xl text-saffron-900/40 leading-tight border-l-4 border-saffron-500/20 pl-8 text-left italic font-medium max-w-lg font-serif-italic">
...
export const GlobalReel = ({ selectedDishes, dishes, onRestart }) => {
  ...
  return (
    <div 
      id="reel-container"
      data-lenis-prevent
      className="snap-y-mandatory h-screen overflow-y-auto bg-cream-base scroll-smooth"
    >
      {/* Navigation Indicator Overlay */}
      <div className="fixed top-10 left-10 md:left-12 z-50 flex items-center gap-6">
      ...
      <section className="h-screen w-full snap-start bg-[#0a0604] flex flex-col items-center justify-center p-6 lg:p-12 relative overflow-hidden">
        {/* Glow Effects */}
        ...
        <motion.div
           ...
           className="w-full max-w-6xl bg-white rounded-[4rem] overflow-hidden shadow-[0_100px_200px_-50px_rgba(0,0,0,0.8)] flex flex-col md:row-reverse md:flex-row-reverse"
        >
          {/* Action Side */}
          <div className="w-full md:w-[45%] bg-[#0a0604] p-12 lg:p-20 flex flex-col justify-center items-center text-center">
             <h2 className="text-white text-5xl lg:text-7xl font-black mb-12 leading-[0.9] tracking-tighter">
             ...
             <div className="w-full space-y-4 max-w-xs">
                <button
                  onClick={onRestart}
                  className="w-full flex items-center justify-center gap-3 bg-white text-[#0a0604] px-10 py-6 rounded-full font-black text-xl hover:bg-saffron-50 transition-all hover:scale-105 active:scale-95"
                >
                  <RotateCcw size={22} />
                  <span>Taste Again</span>
                </button>
                <button
                  className="w-full flex items-center justify-center gap-3 bg-saffron-500 text-white px-10 py-6 rounded-full font-black text-xl hover:bg-saffron-600 transition-all hover:scale-105 shadow-xl shadow-saffron-500/30 active:scale-95"
                  onClick={() => {
          ...
          {/* Identity Card Side */}
          <div className="w-full md:w-[55%] p-12 lg:p-20 bg-gradient-to-br from-white to-saffron-50 relative border-r border-saffron-100">
             ...
             <div className="mb-20">
               ...
               <h4 className="text-7xl lg:text-[7.5rem] font-display font-black text-spice-black leading-[0.8] tracking-tighter">
